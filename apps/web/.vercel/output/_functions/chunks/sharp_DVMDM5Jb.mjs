import { A as AstroError, v as MissingSharp } from './entrypoint_Dsa6HmE5.mjs';
import { b as baseService, p as parseQuality } from './generic_DpbY8-t_.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_Dv6CjsAx.mjs').then(n => n.i)).default;
  } catch {
